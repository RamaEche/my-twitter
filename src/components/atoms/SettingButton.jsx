...
function SettingsSelector({ title, selected = false, onClick}) {
    return (
        <div onClick={()=>onClick()} className={selected ? ' text-white flex justify-between items-center h-[53px] text-[19px] transition bg-mygray' : ' text-white flex justify-between transition items-center h-[53px] text-[19px] hover:bg-mygray'}>
